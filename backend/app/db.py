...
# Managed Postgres providers (e.g. Render) hand out a bare postgres(ql):// connection
# string with no driver marker; psycopg2 is what's installed, so pin it explicitly.
